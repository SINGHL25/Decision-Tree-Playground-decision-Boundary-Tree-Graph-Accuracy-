...
Features:
  • Choose dataset (Iris/Wine/Breast Cancer) or upload your own CSV
  • Pick target column; auto-detects if not provided for built-ins
  • Full DecisionTreeClassifier controls: criterion, splitter, max_depth,
    min_samples_split, min_samples_leaf, min_impurity_decrease, ccp_alpha
  • Train/test split, scaling toggle, random_state
